        ...
        items: [
          {
            ...
            admission_mode: "inline_fast_start",
            fast_path_rejection_reason: null,
          ...
          },
          {
            ...
            admission_mode: "durable_workflow",
            fast_path_rejection_reason: "not_tiny_workflow",
  ...
  if (url.includes("/admin/tenants/tenant-a/task-queues/workflow/payments")) {
    return new Response(
      JSON.stringify({
        ...
        throughput_policy: { backend: "stream-v2" },
        ...
        recent_failures: [
          {
            ...
            admission_mode: "durable_workflow",
            fast_path_rejection_reason: "unsupported_reducer",
            current_state: "charge-card",
            status: "failed",
            event_count: 9,
